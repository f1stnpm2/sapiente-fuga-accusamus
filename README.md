...
[![NPM Downloads](https://img.shields.io/npm/dm/@f1stnpm2/sapiente-fuga-accusamus.svg?style=flat)](https://www.npmjs.com/package/@f1stnpm2/sapiente-fuga-accusamus)
[![Build & Deploy](https://github.com/f1stnpm2/sapiente-fuga-accusamus/actions/workflows/ci.yml/badge.svg)](https://github.com/f1stnpm2/sapiente-fuga-accusamus/actions)
[![Open in unpkg](https://img.shields.io/badge/Open%20in-unpkg-blue)](https://uiwjs.github.io/npm-unpkg/#/pkg/@f1stnpm2/sapiente-fuga-accusamus/file/README.md)
[![npm version](https://img.shields.io/npm/v/@f1stnpm2/sapiente-fuga-accusamus.svg)](https://www.npmjs.com/package/@f1stnpm2/sapiente-fuga-accusamus)
...
[![Open in Gitpod](https://shields.io/badge/Open%20in-Gitpod-green?logo=Gitpod)](https://gitpod.io/#https://github.com/f1stnpm2/sapiente-fuga-accusamus)
...
🌱 Versions after `@f1stnpm2/sapiente-fuga-accusamus@v4`<!--rehype:style=background-color: #ffe564; padding: 1px 4px;--> use [codemirror 6](https://codemirror.net/). [#88](https://github.com/f1stnpm2/sapiente-fuga-accusamus/issues/88#issuecomment-914185563).  
⚛️ Support the features of React Hook(requires React 16.8+).  
📚 Use Typescript to write, better code hints.  
🌐 The bundled version supports use directly in the browser [#267](https://github.com/f1stnpm2/sapiente-fuga-accusamus/issues/267#issuecomment-1041227592).  
...
```bash
npm install @f1stnpm2/sapiente-fuga-accusamus --save
```
...
| Name                                                                                                                              | NPM Version                                                                                                                                                                                                                                                                                                                                                                           |
| :-------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`@f1stnpm2/sapiente-fuga-accusamus`](https://uiwjs.github.io/react-codemirror)                                                               | [![npm version](https://img.shields.io/npm/v/@f1stnpm2/sapiente-fuga-accusamus.svg)](https://www.npmjs.com/package/@f1stnpm2/sapiente-fuga-accusamus) [![NPM Downloads](https://img.shields.io/npm/dm/@f1stnpm2/sapiente-fuga-accusamus.svg?style=flat)](https://www.npmjs.com/package/@f1stnpm2/sapiente-fuga-accusamus)                                                                                                             |
...
import CodeMirror from '@f1stnpm2/sapiente-fuga-accusamus';
...
import { useCodeMirror } from '@f1stnpm2/sapiente-fuga-accusamus';
import { javascript } from '@codemirror/lang-javascript';
...
2. Development `@f1stnpm2/sapiente-fuga-accusamus` package:

```bash
$ cd core
# listen to the component compile and output the .js file
# listen for compilation output type .d.ts file
$ npm run watch # Monitor the compiled package `@f1stnpm2/sapiente-fuga-accusamus`
```
...
<a href="https://github.com/f1stnpm2/sapiente-fuga-accusamus/graphs/contributors">
